...
def create_lmdb_train(datadir, fns, name, matkey,crop_sizes, scales, 
    ksizes, strides, load=h5py.File, augment=True,seed=2017):
    """
    ...
    with env.begin(write=True) as txn:
        ...
        for i, fn in enumerate(fns):
            ...
            for j in range(N):
                ...
                str_id = '{:08}'.format(k)
                k += 1
                txn.put(str_id.encode('ascii'), dumps_pyarrow((channels,height,width,data)))                
...
def create_icvl64_31():
    ...
    datadir = '../Datasets/ICVL/Training/' # your own data address
